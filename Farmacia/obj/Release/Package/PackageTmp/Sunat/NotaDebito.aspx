<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="NotaDebito.aspx.cs" Inherits="Farmacia.Sunat.NotaDebito" %>

<asp:Content ID="Content1" ContentPlaceHolderID="cphCabecera" runat="server"></asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cphPrincipal" runat="server">
	<div class="panel panel-flat">
		<div class="panel-heading">
			<h3 class="panel-title">Nota de Débito Electrónica</h3>
		</div>
						...
						<div class="row">
							<div class="col-md-2">
								<div class="form-group">
									...
									<asp:DropDownList ID="ddlIDSucursal" runat="server" Enabled="false"></asp:DropDownList>
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">

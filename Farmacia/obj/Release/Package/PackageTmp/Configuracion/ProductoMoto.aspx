<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ProductoMoto.aspx.cs" Inherits="Farmacia.Configuracion.ProductoMoto" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphPrincipal" runat="server">
	<div class="panel panel-flat">
		<div class="panel-heading">
			<h3 class="panel-title">Lista de Productos y Servicios</h3>
		</div>
						...
						<ContentTemplate>
							<div class="row">
								...
								<div class="col-md-4">
									<div class="form-group">
										...
										<asp:Button ID="btnExtraerCatalogo" runat="server" Visible="false" SkinID="ui-boton-default" OnClick="btnExtraerCatalogo_Click" Text="Extraer de Catálogo" />
									</div>
								</div>
							</div>
							<div class="table-responsive">
								<asp:GridView ID="gvLista" runat="server" AllowPaging="True" Width="100%" OnPageIndexChanging="gvLista_PageIndexChanging" OnSelectedIndexChanged="gvLista_SelectedIndexChanged" OnRowCommand="gvLista_RowCommand" DataKeyNames="IDProducto" AllowSorting="True" EnableSortingAndPagingCallbacks="True" GridLines="None" AutoGenerateColumns="False">
									<Columns>
										<asp:TemplateField HeaderText="Código" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="10%">
											<ItemTemplate>
												<%# Eval("CodigoAlterna") %>
											</ItemTemplate>
										</asp:TemplateField>
										...
										<asp:TemplateField HeaderText="Descripción" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="20%">
											<ItemTemplate>
												<%# Eval("Nombre") %>
											</ItemTemplate>
										</asp:TemplateField>
										<asp:TemplateField HeaderText="Chasis/Lote/Motor" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="10%">
											<ItemTemplate>
												<b>CHASIS:</b><%# Eval("Chasis") %><br />
												<b>LOTE:</b><%# Eval("NumeroLote") %><br />
												<b>NRO.MOTOR:</b><%# Eval("Motor") %><br /> 
											</ItemTemplate>
										</asp:TemplateField> 
										<asp:TemplateField HeaderText="TipoCombustible" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="10%">
											<ItemTemplate>
												<%# Eval("TipoCombustible") %>
											</ItemTemplate>
										</asp:TemplateField>
										<asp:TemplateField HeaderText="Color" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="10%">
											<ItemTemplate>
												<%# Eval("Color") %>
											</ItemTemplate>
										</asp:TemplateField>
										<asp:TemplateField HeaderText="Año" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="5%">
											<ItemTemplate>
												<%# Eval("AnioModelo") %>
											</ItemTemplate>
										</asp:TemplateField>
										<asp:TemplateField HeaderText="U.M.Venta" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="10%">
											<ItemTemplate>
												<%# Eval("Stock", "{0:N}") %> <%# Eval("UnidadMedidaVenta") %>
											</ItemTemplate>
										</asp:TemplateField> 
							...
							<ContentTemplate>
								...
								<div class="row">
									...
									<div class="col-md-2">
										<div class="form-group">
											<label>Marca:</label>
											<asp:DropDownList ID="ddlIDMarcaVehiculo" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlIDMarcaVehiculo_SelectedIndexChanged"></asp:DropDownList>
										</div>
									</div>
									<div class="col-md-2">
										<div class="form-group">
											<label>Modelo:</label>
											<asp:DropDownList ID="ddlIDModelo" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlIDModelo_SelectedIndexChanged"></asp:DropDownList>
										</div>
									</div>
									<div class="col-md-2">
										<div class="form-group">
											<label>Versión:</label>
											<asp:DropDownList ID="ddlIDModeloVersion" runat="server"></asp:DropDownList>
										</div>
									</div>
								...
								<div class="row">
									<div class="col-md-2">
										<div class="form-group">
											<label>Chasis:</label>
											<asp:TextBox ID="txtChasis" SkinID="ui-textbox-requerido" runat="server"></asp:TextBox>
										</div>
									</div>
									<div class="col-md-2">
										<div class="form-group">
											<label>Lote:</label>
											<asp:TextBox ID="txtNumeroLote" SkinID="ui-textbox-requerido" runat="server"></asp:TextBox>
										</div>
									</div>
									<div class="col-md-2">
										<div class="form-group">
											<label>Nro.Motor:</label>
											<asp:TextBox ID="txtMotor" SkinID="ui-textbox-requerido" runat="server"></asp:TextBox>
										</div>
									</div>
									<div class="col-md-3">
										<div class="form-group">
											<label>Tipo Combustible:</label>
											<asp:DropDownList ID="ddlIDTipoCombustible" SkinID="ui-dropdownlist-requerido" runat="server"></asp:DropDownList>
										</div>
									</div>
									<div class="col-md-3">
										<div class="form-group">
											<label>Color:</label>
											<asp:DropDownList ID="ddlIDColor" SkinID="ui-dropdownlist-requerido" runat="server"></asp:DropDownList>
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-md-4">
										<div class="form-group">
											<label>Nro.DUA:</label>
											<asp:TextBox ID="txtNumeroDUA" SkinID="ui-textbox-requerido" runat="server"></asp:TextBox>
										</div>
									</div>
									<div class="col-md-2">
										<div class="form-group">
											<label>Fecha DUA:</label>
											<asp:TextBox ID="txtFechaDUA" SkinID="ui-textbox-fecha-simple-requerido" runat="server"></asp:TextBox>
										</div>
									</div>
									<div class="col-md-2">
										<div class="form-group">
											<label>Año Modelo:</label>
											<asp:DropDownList ID="ddlAnioModelo" SkinID="ui-dropdownlist-requerido" runat="server"></asp:DropDownList>
										</div>
									</div>
									<div class="col-md-2">
										<div class="form-group">
											<label>Carroceria:</label>
											<asp:DropDownList ID="ddlIDCarroceria" SkinID="ui-dropdownlist-requerido" runat="server"></asp:DropDownList>
										</div>
									</div>
								</div>
								<div class="row">
										...
										<asp:GridView ID="gvProductoPrecioListar" runat="server" DataKeyNames="IdProductoPrecio" AutoGenerateColumns="False" GridLines="None">
											<Columns>
												...
												<asp:TemplateField HeaderText="PrecioVenta" ItemStyle-HorizontalAlign="Right" ItemStyle-Width="10%">
													<ItemTemplate>
														<asp:TextBox ID="txtPrecioVenta" runat="server" SkinID="ui-textbox-price-requerido" Text='<%# Eval("PrecioVenta" , "{0:N}") %>'></asp:TextBox>
													</ItemTemplate>
												</asp:TemplateField>
											</Columns>
										</asp:GridView>

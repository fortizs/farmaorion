<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="UnidadMedida.aspx.cs" Inherits="Farmacia.Configuracion.UnidadMedida" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphPrincipal" runat="server">
			...
			<asp:UpdatePanel ID="upLista" runat="server" UpdateMode="Conditional">
				<ContentTemplate>
					...
					<div class="table-responsive">
						<asp:GridView ID="gvLista" runat="server" DataKeyNames="IDUnidadMedida" AllowPaging="True" Width="100%" OnPageIndexChanging="gvLista_PageIndexChanging" OnSelectedIndexChanged="gvLista_SelectedIndexChanged" OnRowCommand="gvLista_RowCommand" AllowSorting="True" EnableSortingAndPagingCallbacks="True" GridLines="None" AutoGenerateColumns="False">
							<Columns>
								...
								<asp:TemplateField HeaderText="Nombre Corto" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="10%">
									<ItemTemplate>
										<%# Eval("NombreCorto") %>
									</ItemTemplate>
								</asp:TemplateField>
								...
								<asp:TemplateField HeaderText="CódigoSunat" ItemStyle-Width="10%">
									<ItemTemplate>
										<%# Eval("CodigoSunat") %>
									</ItemTemplate>
								</asp:TemplateField>
										...
										<div style="width: 75px;">
											<ul class="icons-list">
												...
												<li style="width: 35px" title="Eliminar">
													<asp:LinkButton ID="lnkEliminar" runat="server" SkinID="ui-link-boton-primario" CausesValidation="False" Visible="true" CommandName="Eliminar" CommandArgument='<%# Eval("IDUnidadMedida").ToString() %>' OnClientClick='<%# String.Format("return Confirmacion(this,event,\"¿Está seguro que deseas eliminar este registro?\",\"{0}\"); return false;", "")%>'><i class="icon-trash"></i></asp:LinkButton>
												</li>
											</ul>
										</div>
									</ItemTemplate>
	...
	<div id="DatosUnidad" class="modal fade" tabindex="-1" role="dialog">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header bg-hmodal">
					<h6 class="modal-title">Datos de la Unidad Medida</h6>
					...
					<asp:UpdatePanel ID="upFormulario" runat="server" UpdateMode="Conditional">
						<ContentTemplate>
								...
								<div class="row">
									...
									<div class="col-md-4">
										<div class="form-group">
											...
											<asp:TextBox ID="txtNombreCorto" SkinID="ui-textbox-requerido" runat="server"></asp:TextBox>
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group">
							...
							<div class="modal-footer">
								<asp:Button ID="btnCancelar" runat="server" Text="Cancelar" SkinID="ui-boton-default" CausesValidation="False" OnClientClick="CerrarModal('DatosUnidad')" />

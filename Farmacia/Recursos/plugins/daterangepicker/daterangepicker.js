...
(function(root, factory) {
  ...
  // Finally, as a browser global.
    ...
    var DateRangePicker = function(element, options, cb) {
        ...
        //Custom
        this.outsideClickUpdateDate = true;
        ...
        if (typeof options.initialValue === 'boolean')
            this.initialValue = options.initialValue;

        if (typeof options.outsideClickUpdateDate === 'boolean')
            this.outsideClickUpdateDate = options.outsideClickUpdateDate;        
    ...
    DateRangePicker.prototype = {
        ...
        hide: function (e) {            
            ...
            if (this.IsOutSideClick && this.outsideClickUpdateDate==false) {
                this.IsOutSideClick = false;                
            } else {
                this.updateElement();
            }            

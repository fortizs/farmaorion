<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="FacturaElectronica.aspx.cs" Inherits="Farmacia.Sunat.FacturaElectronica" ValidateRequest="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="cphCabecera" runat="server"></asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cphPrincipal" runat="server">
	<div class="panel panel-flat">
		<div class="panel-heading">
			<h3 class="panel-title">Facturación Electrónica</h3>
		</div>
				...
				<ContentTemplate>
					...
					<asp:Panel ID="pnBuscar" runat="server" DefaultButton="btnBuscar">
						...
						<div class="table-responsive">
							<asp:GridView ID="gvLista" runat="server" AllowPaging="True" Width="100%" OnPageIndexChanging="gvLista_PageIndexChanging" OnRowCommand="gvLista_RowCommand" DataKeyNames="IDFacturaBoleta" AllowSorting="True" EnableSortingAndPagingCallbacks="True" GridLines="None" AutoGenerateColumns="False">
								<Columns>
									...
									<asp:TemplateField HeaderText="Nro.Doc./Cliente" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="28%">
										<ItemTemplate>
									...
									<asp:TemplateField HeaderText="Acciones" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="12%">
										<ItemTemplate>
											<div style="min-width: 75px;">
												<ul class="icons-list">
													<li style='<%# (Eval("IDEstadoSunat").ToString() == "2" || Eval("IDEstadoSunat").ToString() == "9") ? "display:none;": "width: 35px;" %>' data-popup="tooltip" data-original-title="Enviar a Sunat">
													...
													<li style='<%# (Eval("IDEstadoSunat").ToString() == "2") ? "width: 35px;": "width: 35px;" %>' data-popup="tooltip" data-original-title="Descargar XML-CDR">
													...
													<li style='<%# (Int32.Parse(Eval("IDEstadoSunat").ToString()) == 1) ? "width: 35px;": "display:none;" %>' data-popup="tooltip" title="Anular Comprobante">
														<asp:LinkButton ID="lnkAnular" SkinID="ui-link-boton-primario" runat="server" CausesValidation="False" CommandName="Anular" CommandArgument='<%# Eval("IDFacturaBoleta").ToString() %>' OnClientClick='<%# String.Format("return Confirmacion(this,event,\"¿Está seguro que deseas anular este documento?\",\"{0}\"); return false;", Eval("SerieNumero"))%>'><i class="fa fa-close mr-2"></i></asp:LinkButton>
													</li>
												</ul>
											</div>
										</ItemTemplate>

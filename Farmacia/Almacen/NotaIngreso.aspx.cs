...
{
	public partial class NotaIngreso : PageBase
    {
        ...
        private void CargaInicial()
        {
            ...
            CargarDDL(ddlIDTransaccion, new BLTransaccion().TransaccionNotaIngresoListar("I"), "IDTransaccion", "Nombre", true);
            CalcularTotales();
            Listar();
        }
        ...
        private void Listar()
        {
            ...
            gvLista.DataSource = oBL.NotaIngresoListar(Int32.Parse(ddlBIDSucursal.SelectedValue), Int32.Parse(ddlBIDAlmacen.SelectedValue), txtFechaInicio.Text.Trim(), txtFechaFin.Text.Trim());
            gvLista.DataBind();
            upLista.Update();
        }
        ...
        protected void btnAgregarItem_Click(object sender, EventArgs e)
        {
            ...
            //oBEVentaDet.IDUnidadMedida = oBE.IDUnidadMedida;
            //oBEVentaDet.PrecioUnitario = Decimal.Parse(txtRegPrecioUnitario.Text);
            //oBEVentaDet.Cantidad = Int32.Parse(txtRegCantidad.Text.Trim());
            //oBEVentaDet.SubTotal = Int32.Parse(txtRegCantidad.Text.Trim()) * Decimal.Parse(txtRegPrecioUnitario.Text);
        ...
        protected void ddlIDProducto_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            //SeleccionarProducto(Int32.Parse(ddlIDProducto.SelectedValue));

<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="NotaIngreso.aspx.cs" Inherits="Farmacia.Almacen.NotaIngreso" %>
	...
	<div class="layout-px-spacing">
		<div class="widget-content widget-content-area br-6">
			<div class="panel-heading">
				<h2 class="panel-title">Notas de Ingreso</h2>
			</div>
								...
								<div class="table-responsive">
									<asp:GridView ID="gvLista" runat="server" DataKeyNames="IDMovimiento" OnPageIndexChanging="gvLista_PageIndexChanging" OnRowCommand="gvLista_RowCommand">
										<Columns>
											...
											<asp:BoundField HeaderText="Fecha Emisión" DataField="Fecha" DataFormatString="{0:dd/MM/yyyy}" ItemStyle-Width="10%" ReadOnly="true" ItemStyle-HorizontalAlign="Center" />
							...
							<div class="row">
								<div class="col-md-12 text-right">
									<div class="form-group">
										...
										<asp:LinkButton ID="lnkGuardarAjuste" runat="server" SkinID="ui-link-boton-primario" OnClick="lnkGuardarAjuste_Click"><i class="glyphicon glyphicon-floppy-saved"></i> Guardar Nota Ingreso</asp:LinkButton>
									</div>
								</div>
							</div>
						</ContentTemplate>

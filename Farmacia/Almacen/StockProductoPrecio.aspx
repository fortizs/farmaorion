<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="StockProductoPrecio.aspx.cs" Inherits="Farmacia.Almacen.StockProductoPrecio" %>

<asp:Content ID="Content1" ContentPlaceHolderID="cphCabecera" runat="server"></asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cphPrincipal" runat="server">
	<div class="panel panel-flat">
		<div class="panel-heading">
			<h3 class="panel-title">Stock de Productos y Precios</h3>
		</div>
								...
								<div class="table-responsive" style="margin-bottom: 0;">
									<asp:GridView ID="gvLista" runat="server" DataKeyNames="IdStock" AllowPaging="True" OnPageIndexChanging="gvLista_PageIndexChanging">
										<Columns>
											...
											<asp:TemplateField HeaderText="Precio Costo" ItemStyle-HorizontalAlign="Right" ItemStyle-Width="8%">
												<ItemTemplate>
													<%# "S/." +Eval("PrecioCosto", "{0:n2}") %>
												</ItemTemplate>
											</asp:TemplateField>
											<asp:TemplateField HeaderText="Precio Venta" ItemStyle-HorizontalAlign="Right" ItemStyle-Width="8%">
												<ItemTemplate>
													<%# "S/." +Eval("PrecioVenta", "{0:n2}") %>
												</ItemTemplate>
											</asp:TemplateField>
										</Columns>
									</asp:GridView>

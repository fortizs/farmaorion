<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="NotasAjuste.aspx.cs" Inherits="Farmacia.Almacen.NotasAjuste" %>
            ...
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <div class="widget-content widget-content-area br-6">
                    <div class="panel-heading">
                        <h2 class="panel-title">Notas de Ajuste</h2>
                    </div>
                    ...
                    <div class="tab-content mb-4" id="border-tabsContent">
                        ...
                        <div class="tab-pane fade show" id="tab2" role="tabpanel" aria-labelledby="border-home-tab">
                            <asp:Panel ID="pnRegistroAjuste" runat="server" Enabled="true">
                                <asp:UpdatePanel ID="upRegistroAjuste" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    ...
                                                    <asp:DropDownList ID="ddlIDTransaccion" runat="server">
                                                    </asp:DropDownList>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="table-responsive"  style="overflow-y: scroll; max-height: 800px; margin-bottom: 0;">
                                                    <asp:GridView ID="gvDetalleLista" runat="server" DataKeyNames="IDProducto" AllowPaging="False" Width="100%" AllowSorting="True" GridLines="None" AutoGenerateColumns="False" OnRowDeleting="gvDetalleLista_RowDeleting" OnSelectedIndexChanged="gvDetalleLista_SelectedIndexChanged">
                                                        <Columns>
                                                                ...
                                                                <ItemTemplate>
                                                                    <div style="width: 75px;">
                                                                        <ul class="icons-list" runat="server" id="ulOpciones" visible="true">
                                                                            <li style='<%# (Int32.Parse(Eval("IDMovimiento").ToString()) == 0 )  ? "width: 35px;" : "display:none;" %>' title="Editar Producto">                                                                            
                                                                            ...
                                                                            <li style='<%# (Int32.Parse(Eval("IDMovimiento").ToString()) == 0 )  ? "width: 35px;" : "display:none;" %>' title="Eliminar Producto">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 text-right">
                                                <div class="form-group">
                                                    <asp:LinkButton ID="lnkNuevoAjuste" runat="server" SkinID="ui-link-boton-default" OnClick="lnkNuevoAjuste_Click"><i class="fa fa-hand-paper-o"></i> Nuevo Ajuste</asp:LinkButton>
                                                    <asp:LinkButton ID="lnkGuardarAjuste" runat="server" SkinID="ui-link-boton-primario" OnClick="lnkGuardarAjuste_Click"><i class="glyphicon glyphicon-floppy-saved"></i> Grabar Ajuste</asp:LinkButton>
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    <asp:TemplateField HeaderText="Acciones" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="10%">
                                                        <ItemTemplate>
                                                            <div style="width: 90px;">
                                                                <ul class="icons-list">
                                                                    <li style="width: 35px;">
                                                                        <asp:LinkButton ID="LinkButton1" runat="server" SkinID="ui-link-boton-primario" CausesValidation="False" CommandName="Editar" CommandArgument='<%# Eval("IDLote") %>' ToolTip="Editar"><span class="glyphicon glyphicon-edit"></span></asp:LinkButton>
                                                                    </li>
                                                                    <li style="width: 35px;">
                                                                        <asp:LinkButton ID="LinkButton2" runat="server" SkinID="ui-link-boton-primario" CausesValidation="False" CommandName="Eliminar" CommandArgument='<%# Eval("IDLote") %>' OnClientClick='<%# String.Format("return Confirmacion(this,event,\"¿Está seguro que deseas eliminar este Lote?\",\"{0}\"); return false;", "")%>' ToolTip="Eliminar"><span class="glyphicon glyphicon-trash"></span></asp:LinkButton>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                        </ItemTemplate>

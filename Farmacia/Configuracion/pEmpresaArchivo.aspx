<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pEmpresaArchivo.aspx.cs" Inherits="Farmacia.Configuracion.pEmpresaArchivo" %>
						...
						<div class="col-md-12">
							<div class="form-group">
								...
								<asp:DropDownList ID="ddlTipoArchivo" runat="server">
									<asp:ListItem Value="L">Logo</asp:ListItem>
									<asp:ListItem Value="C">Certificado Electrónico</asp:ListItem>
								</asp:DropDownList>
							</div>
						</div>
					</div> 

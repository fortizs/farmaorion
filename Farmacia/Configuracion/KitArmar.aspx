<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KitArmar.aspx.cs" MasterPageFile="~/Site.Master" Inherits="Farmacia.Configuracion.KitArmar" %>
            ...
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <div class="widget-content widget-content-area br-6">
                    <div class="panel-heading">
                        <h2 class="panel-title">Armado de Kits</h2>
                    </div>
                                        ...
                                        <div class="table-responsive" style="margin-bottom: 0;">
                                            ...
                                            <asp:GridView ID="gvDetalleLista" runat="server" DataKeyNames="IDProducto" AllowPaging="True" Width="100%" AllowSorting="True" GridLines="None" AutoGenerateColumns="False" OnSelectedIndexChanged="gvDetalleLista_SelectedIndexChanged">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Cant. Armado" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="5%">
                                                        <ItemTemplate>

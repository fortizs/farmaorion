...
{
    public partial class KitArmar : PageBase
    {
        ...
        private void CargaInicial()
        {
            ...
            ddlIDTransaccion.SelectedValue = Constantes.ID_Tran_I_Armado_Kit.ToString();
        ...
        private void SetListaDetalle(ref ArrayList ListaDetalle)
        {
            ...
            foreach (GridViewRow row in gvDetalleLista.Rows)
            {
                ...
                if (CantidadArmado == 0) pValidaciones.Append("<div>Cantidad armado debe ser mayor a cero</div>");
        ...
        protected void lnkAplicarLote_Click(object sender, EventArgs e)
        {
            ...
            foreach (GridViewRow row in gvLoteProducto.Rows)
            {
                ...
                if (CantidadLote > StockLote) 
                {
                    msgbox(TipoMsgBox.warning, "Cantidad a retirar no puede ser mayor al Stock del Lote");
                    return;
                }
        ...
        protected void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            if (txtCantidad.Text == "0" || txtCantidad.Text == "") pValidaciones.Append("<div>Ingrese Cantidad de Kits</div>");
            ...
            oBEMov.IDEntidad = 0;
            oBEMov.Entidad = "ARMAR KIT";
            oBEMov.IDTransaccion = Constantes.ID_Tran_S_Armado_Kit; //Salida para Armar Kit
            ...
            if (oBEMov.IDMovimiento.Equals(0))
            {
                ...
                if (oBERetorno.Retorno == "1")
                {
                    ...
                    oBEMovI.IDEntidad = 0;
                    oBEMovI.Entidad = "ARMAR KIT";
                    oBEMovI.IDTransaccion = Constantes.ID_Tran_I_Armado_Kit; //Salida para Armar Kit
                    oBEMovI.TipoMovimiento = "I";

<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="ReporteVendedoresTop.aspx.cs" Inherits="Farmacia.Reportes.ReporteVendedoresTop" %>
            ...
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <div class="widget-content widget-content-area br-6">
                    <div class="panel-heading">
                        <h2 class="panel-title">Reporte Vendedores Top</h2>
                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <asp:Button ID="btnBuscar" runat="server" Text="Buscar" OnClick="btnBuscar_Click"></asp:Button>
											 <a class='btn btn-success btn-xs' id="A1" href="javascript:generar_excel('VEND_TOP');"><i class='icon-cloud-download'></i> Excel</a>
											<asp:LinkButton ID="lnkImprimirPDF" runat="server" Visible="false" OnClick="lnkImprimirPDF_Click" CssClass="btn btn-danger btn-danger" Width="72%"><i class="icon-printer"></i> PDF</a></asp:LinkButton>
                                        </div>
                                    </div> 
                                </div>
                                ...
                                <asp:Panel ID="pnListarGrid" runat="server" Visible="false">
                                    <div class="col-md-8">
                                        <div class="table-responsive" style="background-color: white">
                                            <asp:GridView ID="gvListaColaborador" runat="server" DataKeyNames="IDColaborador" OnPageIndexChanging="gvListaColaborador_PageIndexChanging" AllowPaging="True" Width="100%" AllowSorting="True" EnableSortingAndPagingCallbacks="True" GridLines="None" AutoGenerateColumns="False">
                                                <Columns>
                                                   <asp:TemplateField HeaderText="Sucursal" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="10%">
                                                    ...
                                                    <asp:TemplateField HeaderText="Colaborador" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="20%">
                                                        <ItemTemplate>
                                                            <%# Eval("Colaborador") %>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>

...
{
    public class BLNotaAlmacen : BLBase
    {
        ...
        public IList NotaIngresoListar(Int32 IDSucursal, Int32 IDAlmacen, String FechaInicio, String FechaFin)
        {
            SqlCommand cmd = ConexionCmd("inv.NotaIngresoListar");
        ...
        public IList NotaSalidaListar(Int32 IDSucursal, Int32 IDAlmacen, String FechaInicio, String FechaFin)
        {
            SqlCommand cmd = ConexionCmd("inv.NotaSalidaListar");
            cmd.Parameters.Add("@IDSucursal", SqlDbType.Int).Value = IDSucursal;
            cmd.Parameters.Add("@IDAlmacen", SqlDbType.Int).Value = IDAlmacen;
            cmd.Parameters.Add("@FechaInicio", SqlDbType.VarChar, 10).Value = FechaInicio;
            cmd.Parameters.Add("@FechaFin", SqlDbType.VarChar, 10).Value = FechaFin;
